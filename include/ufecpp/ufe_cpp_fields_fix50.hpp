...
#ifndef UFECPP_FIELDS_FIX50_fb30d5f9_9b77_46fc_8180_e72eef58bfa1_
#define UFECPP_FIELDS_FIX50_fb30d5f9_9b77_46fc_8180_e72eef58bfa1_
	...
	namespace FIX50
	{
		namespace Field
		{
			...
			struct ExecInst
			{
				...
				static inline const std::string REINSTATE_ON_SYSTEM_FAILUE{ "H" };
			...
			struct MsgType
			{
				...
				static inline const std::string QUOTE_RESPONSE{ "AJ" };
				static inline const std::string CONFIRMATION{ "AK" };
				static inline const std::string POSITION_MAINTENANCE_REQUEST{ "AL" };
				static inline const std::string POSITION_MAINTENANCE_REPORT{ "AM" };
				static inline const std::string REQUEST_FOR_POSITIONS{ "AN" };
				static inline const std::string REQUEST_FOR_POSITIONS_ACK{ "AO" };
				static inline const std::string POSITION_REPORT{ "AP" };
				static inline const std::string TRADE_CAPTURE_REPORT_REQUEST_ACK{ "AQ" };
				static inline const std::string TRADE_CAPTURE_REPORT_ACK{ "AR" };
				static inline const std::string ALLOCATION_REPORT{ "AS" };
				static inline const std::string ALLOCATION_REPORT_ACK{ "AT" };
				static inline const std::string CONFIRMATION_ACK{ "AU" };
				static inline const std::string SETTLEMENT_INSTRUCTION_REQUEST{ "AV" };
				static inline const std::string ASSIGNMENT_REPORT{ "AW" };
				static inline const std::string COLLATERAL_REQUEST{ "AX" };
				static inline const std::string COLLATERAL_ASSIGNMENT{ "AY" };
				static inline const std::string COLLATERAL_RESPONSE{ "AZ" };
				static inline const std::string NEWS{ "B" };
				static inline const std::string MASS_QUOTE_ACKNOWLEDGEMENT{ "b" };
				static inline const std::string COLLATERAL_REPORT{ "BA" };
				static inline const std::string COLLATERAL_INQUIRY{ "BB" };
				static inline const std::string NETWORK_COUNTERPARTY_SYSTEM_STATUS_REQUEST{ "BC" };
				static inline const std::string NETWORK_COUNTERPARTY_SYSTEM_STATUS_RESPONSE{ "BD" };
				static inline const std::string USER_REQUEST{ "BE" };
				static inline const std::string USER_RESPONSE{ "BF" };
				static inline const std::string COLLATERAL_INQUIRY_ACK{ "BG" };
				static inline const std::string CONFIRMATION_REQUEST{ "BH" };
				...
				static inline const std::string NEW_ORDER_D{ "D" };
				static inline const std::string SECURITY_STATUS_REQUEST{ "e" };
				static inline const std::string NEW_ORDER_E{ "E" };
				...
				static inline const std::string ALLOCATION_INSTRUCTION{ "J" };
				...
				static inline const std::string ALLOCATION_INSTRUCTION_ACK{ "P" };
				...
				static inline const std::string MARKET_DATA_W{ "W" };
				static inline const std::string SECURITY_LIST_REQUEST{ "x" };
				static inline const std::string MARKET_DATA_X{ "X" };
				...
				static inline const std::string CONTRARY_INTENTION_REPORT{ "BO" };
				static inline const std::string SECURITY_DEFINITION_UPDATE_REPORT{ "BP" };
				static inline const std::string SECURITY_LIST_UPDATE_REPORT{ "BK" };
				static inline const std::string ADJUSTED_POSITION_REPORT{ "BL" };
				static inline const std::string ALLOCATION_INSTRUCTION_ALERT{ "BM" };
				static inline const std::string EXECUTION_ACKNOWLEDGEMENT{ "BN" };
				static inline const std::string TRADING_SESSION_LIST{ "BJ" };
				static inline const std::string TRADING_SESSION_LIST_REQUEST{ "BI" };
			};
			...
			struct Side
			{
				...
				static constexpr char CROSS_SHORT_EXXMPT{ 'A' };
			...
			struct IOIQualifier
			{
				...
				static constexpr char INDIDCATION{ 'W' };
			...
			struct SecurityType
			{
				...
				static inline const std::string WILDCARD_ENTRY{ "WLD" };
			...
			struct HaltReasonChar
			{
				...
				static constexpr char NEW_PENDING{ 'P' };
			...
			struct QuoteEntryRejectReason
			{
				...
				static constexpr int32_t UNKNOWN_SYMBOL{ 1 };
				static constexpr int32_t EXHCNAGE{ 2 };
			...
			struct BusinessRejectReason
			{
				...
				static constexpr int32_t UNKNOWN_MESSAGE_TYPE{ 3 };
			...
			struct MultiLegReportingType
			{
				...
				static constexpr char INDIVIDUAL_LEG_OF_A_MULTILEG_SECURITY{ '2' };
			...
			struct PartyRole
			{
				...
				static constexpr int32_t FORIEGN_FIRM{ 46 };
			...
			struct OrderRestrictions
			{
				...
				static inline const std::string ACTING_AS_MARKET_MAKER_OF_SPECIALIST_IN_THE_UNDERLYING_SECURITY_OF_A_DERIVATIVE_SEUCIRTY{ "6" };
				static inline const std::string FOREIGN_ENTITY{ "7" };
				static inline const std::string EXTERNAL_MARKET_PARTICIPANT{ "8" };
				static inline const std::string EXTNERAL_INTER_CONNECTED_MARKET_LINKAGE{ "9" };
			...
			struct MatchStatus
			{
				...
				static constexpr char UNCOMPARED_UNMATCHED_OR_UNAFFIRED{ '1' };
			...
			struct MatchType
			{
				...
				static inline const std::string ONE_PARTY_PRIVATELY_NEGOTIATED_TRADE_REPORT{ "60" };
				static inline const std::string TWO_PARTY_PRIVATELY_NEGOTIATED_TRADE_REPORT{ "61" };
				static inline const std::string CONTINUOUS_AUTO_MATCH{ "62" };
				static inline const std::string CROSS_AUCTION_63{ "63" };
				static inline const std::string COUNTER_ORDER_SELECTION_64{ "64" };
				static inline const std::string CALL_AUCTION_65{ "65" };
				...
				static inline const std::string CROSS_AUCTION_5{ "5" };
				static inline const std::string COUNTER_ORDER_SELECTION_6{ "6" };
				static inline const std::string CALL_AUCTION_7{ "7" };
			};
			...
			struct TradeRequestResult
			{
				...
				static constexpr int32_t UNAUTHORIZED_ROR_TRADE_CAPTURE_REPORT_REQUEST{ 9 };
				static constexpr int32_t OTHER{ 99 };
			};
			...
			struct TrdSubType
			{
				...
				static constexpr int32_t ONSET_DUT_TO_AN_ALLOCATION{ 6 };
			...
			struct PegScope
			{
				...
				static constexpr int32_t NATIONAL_XXCLUDING_LOCAL{ 4 };
			};
			...
			struct StrategyParameterType
			{
				...
				static constexpr int32_t MONTH_YEAR{ 18 };
				static constexpr int32_t UTCTIMESTAMP{ 19 };
				static constexpr int32_t UTCTIMEONLY{ 20 };
				static constexpr int32_t LOCALMKTTIME{ 21 };
				static constexpr int32_t UTCDATE{ 22 };
			...
			struct SideTrdSubTyp
			{
				...
				static constexpr int32_t CMTA{ 0 };
				static constexpr int32_t INTERNAL_TRANSFER{ 1 };
				static constexpr int32_t EXTERNAL_TRANSFER{ 2 };
				static constexpr int32_t REJECT_FOR_SUBMITTING_TRADE{ 3 };
				static constexpr int32_t ADVISORY_FOR_CONTRA_SIDE{ 4 };
				static constexpr int32_t OFFSET_DUE_TO_AN_ALLOCATION{ 5 };
			...
			struct RefOrderIDSource
			{
				...
				static constexpr char SECONDARYORDEID{ '0' };
				static constexpr char ORDEID{ '1' };
				static constexpr char MENTRYID{ '2' };
				static constexpr char QUOTENTRYID{ '3' };
			};
			...
			struct PegPriceType
			{
				...
				static constexpr int32_t FIXED_PEG_TO_LOCAL_BEST_BID_OR_OFFER_AT_TIME_OF_ORDER{ 6 };
